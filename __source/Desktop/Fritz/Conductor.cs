 ...
 */ 
        ...
        */ 
        ...
        {
          return robot.GetSonarValue();
        }

        public float GetRawIRValue(int pin)
        {
          return robot.GetIRValue(pin);
        }

        public float GetRawSonarValue(int triggerPin, int echoPin)
        {
          return robot.GetSonarValue(triggerPin, echoPin);
        }
        ...
        public int Upload()
        {
          ...
          if (robotStates.Count < 0) return 0;
          ...
          for (i = 0; i < robotStates.Count; i++)
          {
            ...
            if (next.rightEyebrow != -1)
            {
              if (curr.rightEyebrow != next.rightEyebrow)
              {
                if (!delayAdded)
                {
                  ...
                  data.Add((int)(next.position - curr.position)/100);
                  delayAdded = true;
                }

                data.Add(OBJECT_RIGHT_EYEBROW);
                data.Add(1000 - (int)((1.0f - next.rightEyebrow) * 2000.0f));
              }
            }
            ...
            if (next.leftEyebrow != -1)
            {
              if (curr.leftEyebrow != next.leftEyebrow)
              {
                ...
                data.Add(1000 - (int)(next.leftEyebrow * 2000.0f));
              }
            }
            ...
            if (next.rightHorizontalEye != -1)
            {
              if (curr.rightHorizontalEye != next.rightHorizontalEye)
              {
                ...
                data.Add(1000 - (int)(next.rightHorizontalEye * 2000.0f));
              }
            }
            ...
            if (next.leftHorizontalEye != -1)
            {
              if (curr.leftHorizontalEye != next.leftHorizontalEye)
              {
                ...
                data.Add(1000 - (int)(next.leftHorizontalEye * 2000.0f));
              }
            }
            ...
            if (next.rightVerticalEye != -1)
            {
              if (curr.rightVerticalEye != next.rightVerticalEye)
              {
                ...
                data.Add(1000 - (int)(next.rightVerticalEye * 2000.0f));
              }
            }
            ...
            if (next.leftVerticalEye != -1)
            {
              if (curr.leftVerticalEye != next.leftVerticalEye)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.leftVerticalEye) * 2000.0f));
              }
            }
            ...
            if (next.rightEyelid != -1)
            {
              if (curr.rightEyelid != next.rightEyelid)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.rightEyelid) * 2000.0f));
              }
            }
            ...
            if (next.leftEyelid != -1)
            {
              if (curr.leftEyelid != next.leftEyelid)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.leftEyelid) * 2000.0f));
              }
            }
            ...
            if (next.neckTilt != -1)
            {
              if (curr.neckTilt != next.neckTilt)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.neckTilt) * 2000.0f));
              }
            }
            ...
            if (next.neckTwist != -1)
            {
              if (curr.neckTwist != next.neckTwist)
              {
                ...
                data.Add(1000 - (int)(next.neckTwist * 2000.0f));
              }
            }
            ...
            if (next.leftLip != -1)
            {
              if (curr.leftLip != next.leftLip)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.leftLip) * 2000.0f));
              }
            }
            ...
            if (next.rightLip != -1)
            {
              if (curr.rightLip != next.rightLip)
              {
                ...
                data.Add(1000 - (int)((1.0f - next.rightLip) * 2000.0f));
              }
            }
            ...
            if (next.jaw != -1)
            {
              if (curr.jaw != next.jaw)
              {
                ...
                data.Add(OBJECT_JAW);
                data.Add(1000 - (int)((1.0f - next.jaw) * 2000.0f));
              }
            }
          ...
          int byteSize = ((data.Count/2)*3);
          if (byteSize > MAX_SEQ_BYTES) byteSize = MAX_SEQ_BYTES;
          // create a byte array that represents 3 bytes per entry
          byte []bytes = new byte[byteSize];

          for (j = i = 0; (i < data.Count)&&((j+2)<byteSize); i += 2)
          {
            bytes[j++] = (byte)data.ElementAt(i);
            int value = data.ElementAt(i + 1);
            bytes[j++] = (byte)(value & 255);
            bytes[j++] = (byte)(value >> 8);
          }

          int res = robot.SaveSequence(bytes);
          if (byteSize >= MAX_SEQ_BYTES)
            return -(((data.Count / 2) * 3) - MAX_SEQ_BYTES);
          else
            return res+2;
        }
    }
