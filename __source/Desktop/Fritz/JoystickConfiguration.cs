...
namespace Fritz
{
    public partial class JoystickConfiguration : Form
    {
        ...
        bool[] buttons = { false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false };
        ...
        public JoystickConfiguration()
        {
            ...
            comboBox13.Items.AddRange(Conductor.singleValueOptions);
            comboBox13.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_north, "");
            checkBox1.Checked = Fritz.Properties.Settings.Default.Joystick_view_north_revert;

            comboBox14.Items.AddRange(Conductor.singleValueOptions);
            comboBox14.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_south_east, "");
            checkBox2.Checked = Fritz.Properties.Settings.Default.Joystick_view_south_east_revert;

            comboBox15.Items.AddRange(Conductor.singleValueOptions);
            comboBox15.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_east, "");
            checkBox3.Checked = Fritz.Properties.Settings.Default.Joystick_view_east_revert;

            comboBox16.Items.AddRange(Conductor.singleValueOptions);
            comboBox16.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_north_east, "");
            checkBox4.Checked = Fritz.Properties.Settings.Default.Joystick_view_north_east_revert;

            comboBox17.Items.AddRange(Conductor.singleValueOptions);
            comboBox17.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_north_west, "");
            checkBox5.Checked = Fritz.Properties.Settings.Default.Joystick_view_north_west_revert;

            comboBox18.Items.AddRange(Conductor.singleValueOptions);
            comboBox18.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_west, "");
            checkBox6.Checked = Fritz.Properties.Settings.Default.Joystick_view_west_revert;

            comboBox19.Items.AddRange(Conductor.singleValueOptions);
            comboBox19.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_south_west, "");
            checkBox7.Checked = Fritz.Properties.Settings.Default.Joystick_view_south_west_revert;

            comboBox20.Items.AddRange(Conductor.singleValueOptions);
            comboBox20.SelectedIndex = Conductor.GetSingleIndex(Fritz.Properties.Settings.Default.Joystick_view_south, "");
            checkBox8.Checked = Fritz.Properties.Settings.Default.Joystick_view_south_revert;
        }
        ...
        {
          if (b) disabled = false; else disabled = true;
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            foreach (JoystickUpdate state in datas)
            {
                ...
                {
                  //label17.Text = Convert.ToString(state.Value);

                  if (state.Value == 0)
                  {
                    if (!buttons[13])
                    {
                      conductor.Set((string)comboBox13.SelectedItem, true);
                      buttons[13] = true;
                    }
                    ...
                    if (state.Value != 0)
                    {
                      if (buttons[13])
                      {
                        if (checkBox1.Checked)
                          conductor.Set((string)comboBox13.SelectedItem, false);
                        buttons[13] = false;
                      }
                      label18.Text = "0";
                  ...
                  if (state.Value == 13500)
                  {
                    if (!buttons[14])
                    {
                      conductor.Set((string)comboBox14.SelectedItem, true);
                      buttons[14] = true;
                    }
                  ...
                  if (state.Value != 13500)
                  {
                    if (buttons[14])
                    {
                      if (checkBox2.Checked)
                        conductor.Set((string)comboBox14.SelectedItem, false);
                      buttons[14] = false;
                    }
                    label22.Text = "0";
                  ...
                  if (state.Value == 9000)
                  {
                    if (!buttons[15])
                    {
                      conductor.Set((string)comboBox15.SelectedItem, true);
                      buttons[15] = true;
                    }
                    ...
                    if (state.Value != 9000)
                    {
                      if (buttons[15])
                      {
                        if (checkBox3.Checked)
                          conductor.Set((string)comboBox15.SelectedItem, false);
                        buttons[15] = false;
                      }
                      label23.Text = "0";
                  ...
                  if (state.Value == 4500)
                  {
                    if (!buttons[16])
                    {
                      conductor.Set((string)comboBox16.SelectedItem, true);
                      buttons[16] = true;
                    }
                    ...
                    if (state.Value != 4500)
                    {
                      if (buttons[16])
                      {
                        if (checkBox4.Checked)
                          conductor.Set((string)comboBox16.SelectedItem, false);
                        buttons[16] = false;
                      }
                      label24.Text = "0";
                  ...
                  if (state.Value == 31500)
                  {
                    if (!buttons[17])
                    {
                      conductor.Set((string)comboBox17.SelectedItem, true);
                      buttons[17] = true;
                    }
                    ...
                    if (state.Value != 31500)
                    {
                      if (buttons[17])
                      {
                        if (checkBox5.Checked)
                          conductor.Set((string)comboBox17.SelectedItem, false);
                        buttons[17] = false;
                      }
                      label31.Text = "0";
                  ...
                  if (state.Value == 27000)
                  {
                    if (!buttons[18])
                    {
                      conductor.Set((string)comboBox18.SelectedItem, true);
                      buttons[18] = true;
                    }
                    ...
                    if (state.Value != 27000)
                    {
                      if (buttons[18])
                      {
                        if (checkBox6.Checked)
                          conductor.Set((string)comboBox18.SelectedItem, false);
                        buttons[18] = false;
                      }
                      label32.Text = "0";
                  ...
                  if (state.Value == 22500)
                  {
                    if (!buttons[19])
                    {
                      conductor.Set((string)comboBox19.SelectedItem, true);
                      buttons[19] = true;
                    }
                    ...
                    if (state.Value != 22500)
                    {
                      if (buttons[19])
                      {
                        if (checkBox7.Checked)
                          conductor.Set((string)comboBox19.SelectedItem, false);
                        buttons[19] = false;
                      }
                      label33.Text = "0";
                  ...
                  if (state.Value == 18000)
                  {
                    if (!buttons[20])
                    {
                      conductor.Set((string)comboBox20.SelectedItem, true);
                      buttons[20] = true;
                    }
                    ...
                    if (state.Value != 18000)
                    {
                      if (buttons[20])
                      {
                        if (checkBox8.Checked)
                          conductor.Set((string)comboBox20.SelectedItem, false);
                        buttons[20] = false;
                      }
                      label34.Text = "0";
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            Fritz.Properties.Settings.Default.Joystick_view_north = comboBox13.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_north_revert = checkBox1.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_south_east = comboBox14.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_south_east_revert = checkBox2.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_east = comboBox15.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_east_revert = checkBox3.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_north_east = comboBox16.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_north_east_revert = checkBox4.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_north_west = comboBox17.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_north_west_revert = checkBox5.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_west = comboBox18.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_west_revert = checkBox6.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_south_west = comboBox19.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_south_west_revert = checkBox7.Checked;

            Fritz.Properties.Settings.Default.Joystick_view_south = comboBox20.SelectedItem.ToString();
            Fritz.Properties.Settings.Default.Joystick_view_south_revert = checkBox8.Checked;
